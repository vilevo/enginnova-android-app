...
class Participant extends Model {
    ...
    protected $fillable = ['last_name', 'first_name', 'email', 'username', 'biography',
                            'quarter', 'job', 'enterprise', 'phone_number', 'website',
                        'linkedin', 'facebook', 'twitter', 'birth_date'];

    /**
     * The competencies that belong to the Participant
     */
    public function competencies(){
        return $this->belongsToMany("App\Competency", "competencies_participants",
    "participant_id", "competency_id");
    }
    ...
    public function interests(){
        return $this->belongsToMany("App\Interest", "interests_participants",
    "participant_id", "interest_id");
    }
